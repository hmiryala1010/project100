        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className="navbar-text d-flex align-items-center">
            <div className="social-icon">
              <a href="https://www.linkedin.com/in/hasinimiryala/"><img src={navIcon1} alt="LinkedIn" /></a>
              <a href="https://medium.com/@hasini.miryala7585"><img src={navIcon2} alt="Medium" /></a>
              <a href="https://github.com/hmiryala1010"><img src={navIcon4} alt="GitHub" /></a>
            </div>
            ...
            <a href="/resume.pdf" download style={{ marginLeft: '10px' }}>
